...
public class Book {
   ...
   The value of the first is used to initialize the value of title and the value of the second is used to initialize author.
   ...
   toString returns a String consisting of the value of title, followed by a newline character, followed by the value of author.
    ...
    public void addChapter(String titleChapter, int numberOfPagesinChapter) {

        tableOfContents += "\n" + titleChapter + "..." + nextPage;
        nextPage += numberOfPagesinChapter;

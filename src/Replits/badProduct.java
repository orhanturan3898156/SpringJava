...
to declare if the products shipment was good or bad it also get
a limited number of how many products can be broken for it to be considered a good shipment.
...
if the item is intact it will be represented by 1 if its broken its 0. for example: [0,1,1,1,0],
